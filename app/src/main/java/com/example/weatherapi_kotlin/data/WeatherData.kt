...
data class WeekList(val dt:String, val weather:ArrayList<WeatherData>, val main:MainData, val clouds:CloudData, val dt_txt:String)
data class WeatherData(val main:String, val description:String, val temp_max:String, val humidity:String)
